              ...
              <div class="row">
                <div class="col-md-4">                
                  ...
                  <div class="form-group">
                    <label for="Password Siswa">Nama Santri</label>
                    <input value=""  type="text" class="form-control" name="ayah">
                  </div>
                 
                  <div class="form-group">
                    <label for="Password Orang Tua">Subuh</label>
                    <input value=""  type="text" class="form-control" name="wali">
                  </div>  

                  <div class="form-group">
                    <label for="Password Orang Tua">Maghrib</label>
                    <input value=""  type="text" class="form-control" name="wali">
                  </div>                          

                   <div class="form-group">
                    <label for="Password Orang Tua">Isyak</label>
                    <input value=""  type="text" class="form-control" name="ibu">
                  </div>
                   <div class="form-group">
                    <label for="Password Orang Tua">Tanggal</label>
